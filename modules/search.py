...
class GeneticAlgorithmSearch:
    ...
    @abstractmethod
    def _evaluate_chromosome2(self, chromosome):
        raise NotImplementedError
    ...
    def run_search(self):
        ...
        for i in range(self.num_generations):
            ...
            self.__verbose('\tBest score so far = {} {}'.format(self._evaluate_chromosome(self._best_so_far), self._evaluate_chromosome2(self._best_so_far)))

            # Creating new population
            new_population = []

            # Copy best over if needed
            if self.keep_best and not self._should_exclude(self._best_so_far):
            ...
            while len(new_population) < len(self._current_population):
                ...
                #self.__verbose('\tAppending = {} {}'.format(self._evaluate_chromosome(child), self._evaluate_chromosome2(child)))
